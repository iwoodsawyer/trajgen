...
#define S_FUNCTION_NAME  sfun_trajgen_vel
...
{
    int_T nInputPorts  = 4;  // number of input ports
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if (ssGetIWorkValue(S, 0) == 1) {
        ...
        InputRealPtrsType current_pos_ptr = ssGetInputPortRealSignalPtrs(S,1);
        InputRealPtrsType current_vel_ptr = ssGetInputPortRealSignalPtrs(S,2);
        InputRealPtrsType current_acc_ptr = ssGetInputPortRealSignalPtrs(S,3);
    ...
    else
    {
        ...
        RMLVelocityOutputParameters *OP = static_cast<RMLVelocityOutputParameters *>(ssGetPWork(S)[2]);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    RMLVelocityInputParameters  *IP    = static_cast<RMLVelocityInputParameters *>(ssGetPWork(S)[1]);
    RMLVelocityOutputParameters *OP    = static_cast<RMLVelocityOutputParameters *>(ssGetPWork(S)[2]);
    RMLVelocityFlags            *FLAGS = static_cast<RMLVelocityFlags *>(ssGetPWork(S)[3]);
    
    // Get data addresses of I/O
    InputRealPtrsType target_vel_ptr  = ssGetInputPortRealSignalPtrs(S,0);
    InputRealPtrsType current_pos_ptr = ssGetInputPortRealSignalPtrs(S,1);
    InputRealPtrsType current_vel_ptr = ssGetInputPortRealSignalPtrs(S,2);
    InputRealPtrsType current_acc_ptr = ssGetInputPortRealSignalPtrs(S,3);
...
static void mdlRTW(SimStruct *S)
{
    ...
    if (!ssWriteRTWWorkVect(S, "PWork", 4,
            "ReflexxesAPI", 1,
            "RMLVelocityInputParameters", 1,
            "RMLVelocityOutputParameters", 1,
            "RMLVelocityFlags", 1) )
    {
        return;
    }
